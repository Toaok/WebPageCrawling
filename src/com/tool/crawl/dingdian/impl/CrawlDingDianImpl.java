package com.tool.crawl.dingdian.impl;
 ...
 */
public class CrawlDingDianImpl extends CrawlDingDian implements CrawlDingDian.Callback {

    private GeneratingTXTDocuments documents;


    public CrawlDingDianImpl(String url) {
        super(url);
    }
